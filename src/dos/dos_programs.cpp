...
void DOS_SetupPrograms(void)
{
	...
	MSG_Add("PROGRAM_INTRO_CDROM_OTHER",
	        ...
	        "For \033[1mWindows 9x\033[0m with a ASPI layer installed:\n"
	        "\033[34;1mmount d \033[0;31m~/example\033[34;1m -t cdrom -usecd \033[33m0 \033[34m-aspi\033[0m\n"
	...
	MSG_Add("SHELL_CMD_MOUNT_HELP_LONG",
	        ...
	        "  [color=green]mount[reset] -cd  (lists all detected CD-ROM drives and their numbers)\n"
